{
    const $___mock_d55897ef0d064591 = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        (function (E) {
            ...
            var Dg = function (a) {
                    ...
                    const $___old_97aed87a6add42c3 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_e6a39b0e741fb83c = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_97aed87a6add42c3)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_d55897ef0d064591.XMLHttpRequest));
                        if ($___old_e6a39b0e741fb83c)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_d55897ef0d064591.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_97aed87a6add42c3)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_97aed87a6add42c3));
                        if ($___old_e6a39b0e741fb83c)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_e6a39b0e741fb83c));
                    }
                }, Ng = function (a, b, c, d) {
                    sg(172, d);
                    sg(259, Hg(a));
