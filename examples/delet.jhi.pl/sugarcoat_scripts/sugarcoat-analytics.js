{
    const $___mock_563c340106c79bc1 = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        ...
        (function () {
            ...
            var bd = function (a) {
                    ...
                    const $___old_c509eb0c19f89769 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_5ef04cc485c2b249 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_c509eb0c19f89769)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_563c340106c79bc1.XMLHttpRequest));
                        if ($___old_5ef04cc485c2b249)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_563c340106c79bc1.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_c509eb0c19f89769)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_c509eb0c19f89769));
                        if ($___old_5ef04cc485c2b249)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_5ef04cc485c2b249));
                    }
                }, Ea = function (a, b, c) {
                    if (1 > b.length)
                        ge('xhr', 'ver', '0'), c();
