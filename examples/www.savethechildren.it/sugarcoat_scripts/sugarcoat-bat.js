var UET, UET_init, UET_push;
{
    ...
    (function () {
        ...
        UET_init = $___var_57460ae036d7c1b4;
        ...
        UET_push = $___var_c79207f6daba9b43;
        ...
        function $___var_b7bdbfd5999d1500(o) {
            ...
            this.loadConfig = function () {
                const $___old_0862e55c1705e262 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_917bab48db31b600 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                try {
                    if ($___old_0862e55c1705e262)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_13da263efe72b2c9.XMLHttpRequest));
                    if ($___old_917bab48db31b600)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_13da263efe72b2c9.XMLHttpRequest));
                    return function () {
                        var t, e, r, u, f, i, n;
                    ...
                    if ($___old_0862e55c1705e262)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_0862e55c1705e262));
                    if ($___old_917bab48db31b600)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_917bab48db31b600));
                }
            };
            this.push = function () {
            ...
            this.setLocalStorageBackup = function (n, t, i) {
                const $___old_fb1e1d039ec8994c = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                try {
                    if ($___old_fb1e1d039ec8994c)
                    ...
                    if ($___old_fb1e1d039ec8994c)
                        ({}.constructor.defineProperty(window, 'localStorage', $___old_fb1e1d039ec8994c));
                }
            };
            this.getLocalStorageBackup = function (n, t) {
                const $___old_142972cd0886999a = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                try {
                    if ($___old_142972cd0886999a)
                        ({}.constructor.defineProperty(window, 'localStorage', $___mock_4a58cbe783a19966.localStorage));
                    return function () {
                        var r, i;
                        try {
                    ...
                    if ($___old_142972cd0886999a)
                        ({}.constructor.defineProperty(window, 'localStorage', $___old_142972cd0886999a));
                }
            };
