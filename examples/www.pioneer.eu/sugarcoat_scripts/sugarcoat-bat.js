...
{
    const $___mock_314ad23b3005546a = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    })($___mock_314ad23b3005546a);
    const $___mock_67d4ef55750e784e = {};
    (exports => {
        'use strict';
        let isSealed = false;
        class Storage {
        ...
        isSealed = true;
    })($___mock_67d4ef55750e784e);
    (function () {
        UET = $___var_cd46185678454ff1;
        ...
        UET_init = $___var_08498a42f475e7f0;
        ...
        UET_push = $___var_a83e4e762082acb3;
        ...
        function $___var_cd46185678454ff1(o) {
            ...
            this.loadConfig = function () {
                const $___old_194a83236fa7cac0 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_b0cb782a88fa2fc4 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                try {
                    if ($___old_194a83236fa7cac0)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_314ad23b3005546a.XMLHttpRequest));
                    if ($___old_b0cb782a88fa2fc4)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_314ad23b3005546a.XMLHttpRequest));
                    return function () {
                        var t, e, r, u, f, i, n;
                    ...
                    if ($___old_194a83236fa7cac0)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_194a83236fa7cac0));
                    if ($___old_b0cb782a88fa2fc4)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_b0cb782a88fa2fc4));
                }
            };
            this.push = function () {
            ...
            this.setLocalStorageBackup = function (n, t, i) {
                const $___old_304e0a1a3e4a1ba2 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                try {
                    if ($___old_304e0a1a3e4a1ba2)
                        ({}.constructor.defineProperty(window, 'localStorage', $___mock_67d4ef55750e784e.localStorage));
                    return function () {
                        try {
                            var r = new Date();
                    ...
                    if ($___old_304e0a1a3e4a1ba2)
                        ({}.constructor.defineProperty(window, 'localStorage', $___old_304e0a1a3e4a1ba2));
                }
            };
            this.getLocalStorageBackup = function (n, t) {
                const $___old_1bbf02ed8f36d131 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                try {
                    if ($___old_1bbf02ed8f36d131)
                        ({}.constructor.defineProperty(window, 'localStorage', $___mock_67d4ef55750e784e.localStorage));
                    return function () {
                        var r, i;
                        try {
                    ...
                    if ($___old_1bbf02ed8f36d131)
                        ({}.constructor.defineProperty(window, 'localStorage', $___old_1bbf02ed8f36d131));
                }
            };
