...
{
    const $___mock_edfbb9d40952844b = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    })($___mock_edfbb9d40952844b);
    (function () {
        AppMeasurement_Module_AudienceManagement = $___var_59f07280f2bf47f0;
        ...
        function $___var_59f07280f2bf47f0(e) {
            var t = this;
            t.s = e;
            var n = window;
        ...
        !function () {
            ...
            'function' != typeof window.DIL && (window.DIL = function (n, e) {
                const $___old_bd31c19696abd3a7 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_b1cb5333064e924f = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                try {
                    if ($___old_bd31c19696abd3a7)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_edfbb9d40952844b.XMLHttpRequest));
                    if ($___old_b1cb5333064e924f)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_edfbb9d40952844b.XMLHttpRequest));
                    return function () {
                        function t(e) {
                            return void 0 === e || !0 === e;
                    ...
                    if ($___old_bd31c19696abd3a7)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_bd31c19696abd3a7));
                    if ($___old_b1cb5333064e924f)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_b1cb5333064e924f));
                }
