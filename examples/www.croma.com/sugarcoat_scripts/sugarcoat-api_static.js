{
    const $___mock_77be23fd8bf062bf = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    })($___mock_77be23fd8bf062bf);
    const $___mock_8aa444d135ceef3c = {};
    (exports => {
        'use strict';
        let isSealed = false;
        class Storage {
    ...
    (function () {
        window.DYO = window.DYO || {}, void 0 === window.DY && (window.DY = {}), void 0 === window.DY.API && (window.DY.API = function () {
            ...
            if (a()) {
                ...
                var g = function (a) {
                    const $___old_005181f29e314ae7 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_005181f29e314ae7)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_77be23fd8bf062bf.XMLHttpRequest));
                        return function () {
                            return new Promise(a);
                        }.apply(this, arguments);
                    } finally {
                        if ($___old_005181f29e314ae7)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_005181f29e314ae7));
                    }
                };
            ...
            function a(a) {
                const $___old_c807aa0281b406e7 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage'), $___old_6d4c3387e256e0c8 = {}.constructor.getOwnPropertyDescriptor(window, 'sessionStorage');
                try {
                    if ($___old_c807aa0281b406e7)
                        ({}.constructor.defineProperty(window, 'localStorage', $___mock_8aa444d135ceef3c.localStorage));
                    if ($___old_6d4c3387e256e0c8)
                        ({}.constructor.defineProperty(window, 'sessionStorage', $___mock_8aa444d135ceef3c.sessionStorage));
                    return function () {
                        try {
                    ...
                    if ($___old_c807aa0281b406e7)
                        ({}.constructor.defineProperty(window, 'localStorage', $___old_c807aa0281b406e7));
                    if ($___old_6d4c3387e256e0c8)
                        ({}.constructor.defineProperty(window, 'sessionStorage', $___old_6d4c3387e256e0c8));
                }
            }
            function b(a) {
            ...
            return k.memoryStorage = function () {
                ...
                const $___old_cecd8b68b63e7464 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                try {
                    if ($___old_cecd8b68b63e7464)
                        ({}.constructor.defineProperty(window, 'localStorage', $___mock_8aa444d135ceef3c.localStorage));
                    return function () {
                        if (!b())
                    ...
                    if ($___old_cecd8b68b63e7464)
                        ({}.constructor.defineProperty(window, 'localStorage', $___old_cecd8b68b63e7464));
                }
            }(), k.sessionStorage = function () {
                const $___old_1fbbe2deb5758707 = {}.constructor.getOwnPropertyDescriptor(window, 'sessionStorage');
                try {
                    if ($___old_1fbbe2deb5758707)
                        ({}.constructor.defineProperty(window, 'sessionStorage', $___mock_8aa444d135ceef3c.sessionStorage));
                    return function () {
                        if (!b())
                    ...
                    if ($___old_1fbbe2deb5758707)
                        ({}.constructor.defineProperty(window, 'sessionStorage', $___old_1fbbe2deb5758707));
                }
            ...
            function f(a, b, c) {
                ...
                function g() {
                    const $___old_0b8b747781df87b8 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                    try {
                        if ($___old_0b8b747781df87b8)
                            ({}.constructor.defineProperty(window, 'localStorage', $___mock_8aa444d135ceef3c.localStorage));
                        return function () {
                            var a;
                            try {
                        ...
                        if ($___old_0b8b747781df87b8)
                            ({}.constructor.defineProperty(window, 'localStorage', $___old_0b8b747781df87b8));
                    }
                }
