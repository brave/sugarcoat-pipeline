{
    const $___mock_71067b3a82bae005 = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        ...
        (function () {
            ...
            var bd = function (a) {
                    ...
                    const $___old_4ae56102074c5699 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_4c140ddd8c9e44d0 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_4ae56102074c5699)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_71067b3a82bae005.XMLHttpRequest));
                        if ($___old_4c140ddd8c9e44d0)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_71067b3a82bae005.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_4ae56102074c5699)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_4ae56102074c5699));
                        if ($___old_4c140ddd8c9e44d0)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_4c140ddd8c9e44d0));
                    }
                }, Ea = function (a, b, c) {
                    if (1 > b.length)
                        ge('xhr', 'ver', '0'), c();
