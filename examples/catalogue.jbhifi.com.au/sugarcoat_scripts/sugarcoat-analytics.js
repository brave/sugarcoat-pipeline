{
    const $___mock_b137a35509e720bc = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        ...
        (function () {
            ...
            var bd = function (a) {
                    ...
                    const $___old_bf81c07c7104eb6c = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_e49b633621add5a4 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_bf81c07c7104eb6c)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_b137a35509e720bc.XMLHttpRequest));
                        if ($___old_e49b633621add5a4)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_b137a35509e720bc.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_bf81c07c7104eb6c)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_bf81c07c7104eb6c));
                        if ($___old_e49b633621add5a4)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_e49b633621add5a4));
                    }
                }, Ea = function (a, b, c) {
                    if (1 > b.length)
                        ge('xhr', 'ver', '0'), c();
