{
    const $___mock_807411b6236652ce = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        ...
        (function () {
            ...
            var bd = function (a) {
                    ...
                    const $___old_ab80fbceeaa17017 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_69dd84e2a123f9ef = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_ab80fbceeaa17017)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_807411b6236652ce.XMLHttpRequest));
                        if ($___old_69dd84e2a123f9ef)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_807411b6236652ce.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_ab80fbceeaa17017)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_ab80fbceeaa17017));
                        if ($___old_69dd84e2a123f9ef)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_69dd84e2a123f9ef));
                    }
                }, Ea = function (a, b, c) {
                    if (1 > b.length)
                        ge('xhr', 'ver', '0'), c();
