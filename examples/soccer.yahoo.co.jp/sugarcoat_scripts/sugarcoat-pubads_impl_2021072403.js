{
    const $___mock_7c1deef3bab6ad06 = {};
    (exports => {
        'use strict';
        let isSealed = false;
        class Storage {
        ...
        isSealed = true;
    })($___mock_7c1deef3bab6ad06);
    const $___mock_e3876b5e1f72552e = {};
    (exports => {
        'use strict';
    ...
    })($___mock_e3876b5e1f72552e);
    const $___mock_17b959a9ec04c6ec = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        (function (_) {
            ...
            Dc = function (a, b) {
                const $___old_fc5e2bb6443a6826 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                try {
                    if ($___old_fc5e2bb6443a6826)
                        ({}.constructor.defineProperty(window, 'localStorage', $___mock_7c1deef3bab6ad06.localStorage));
                    return function () {
                        b = void 0 === b ? window : b;
                        if (y(a, 5))
                            try {
                    ...
                    if ($___old_fc5e2bb6443a6826)
                        ({}.constructor.defineProperty(window, 'localStorage', $___old_fc5e2bb6443a6826));
                }
            };
            Ec = function (a) {
            ...
            Yj = function (a, b) {
                const $___old_29ef261a921d7189 = {}.constructor.getOwnPropertyDescriptor(window, 'fetch');
                try {
                    if ($___old_29ef261a921d7189)
                        ({}.constructor.defineProperty(window, 'fetch', $___mock_e3876b5e1f72552e.fetch));
                    return function () {
                        a.write(_.Vj(b));
                    }.apply(this, arguments);
                } finally {
                    if ($___old_29ef261a921d7189)
                        ({}.constructor.defineProperty(window, 'fetch', $___old_29ef261a921d7189));
                }
            };
            ak = function (a, b, c) {
                a.rel = c;
            ...
            var QE = function (a, b, c) {
                    const $___old_808bd46aa77ec596 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_b5c70ec62277ba96 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_808bd46aa77ec596)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_17b959a9ec04c6ec.XMLHttpRequest));
                        if ($___old_b5c70ec62277ba96)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_17b959a9ec04c6ec.XMLHttpRequest));
                        return function () {
                            this.url = a;
                            this.m = b;
                        ...
                        if ($___old_808bd46aa77ec596)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_808bd46aa77ec596));
                        if ($___old_b5c70ec62277ba96)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_b5c70ec62277ba96));
                    }
                }, TE = function (a) {
                    a.j.open('GET', a.url);
