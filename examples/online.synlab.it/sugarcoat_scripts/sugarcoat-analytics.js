{
    const $___mock_c56c1c811aaa5cff = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        ...
        (function () {
            ...
            var bd = function (a) {
                    ...
                    const $___old_12736a944c9c2c2c = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_75dbb20eace0aade = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_12736a944c9c2c2c)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_c56c1c811aaa5cff.XMLHttpRequest));
                        if ($___old_75dbb20eace0aade)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_c56c1c811aaa5cff.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_12736a944c9c2c2c)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_12736a944c9c2c2c));
                        if ($___old_75dbb20eace0aade)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_75dbb20eace0aade));
                    }
                }, Ea = function (a, b, c) {
                    if (1 > b.length)
                        ge('xhr', 'ver', '0'), c();
