{
    const $___mock_bd8fea53465b399f = {};
    (exports => {
        'use strict';
        let isSealed = false;
        class Storage {
        ...
        isSealed = true;
    })($___mock_bd8fea53465b399f);
    const $___mock_c42467539e5891a4 = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        !function (t) {
            ...
            function (t, e, n) {
                ...
                function f() {
                    const $___old_8024992c6e663136 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                    try {
                        if ($___old_8024992c6e663136)
                            ({}.constructor.defineProperty(window, 'localStorage', $___mock_bd8fea53465b399f.localStorage));
                        return function () {
                            var t = 'amzn_lsTest';
                            try {
                        ...
                        if ($___old_8024992c6e663136)
                            ({}.constructor.defineProperty(window, 'localStorage', $___old_8024992c6e663136));
                    }
                }
                function b(t, e) {
            ...
            function (t, e, n) {
                const $___old_7cb3a12953b6a365 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_2e64882af126a6bd = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                try {
                    if ($___old_7cb3a12953b6a365)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_c42467539e5891a4.XMLHttpRequest));
                    if ($___old_2e64882af126a6bd)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_c42467539e5891a4.XMLHttpRequest));
                    return function () {
                        'use strict';
                        n.d(e, 'g', function () {
                    ...
                    if ($___old_7cb3a12953b6a365)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_7cb3a12953b6a365));
                    if ($___old_2e64882af126a6bd)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_2e64882af126a6bd));
                }
            },
            function (t, e, n) {
                'use strict';
                ...
                function w() {
                    const $___old_5f2a47462580f2af = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                    try {
                        if ($___old_5f2a47462580f2af)
                            ({}.constructor.defineProperty(window, 'localStorage', $___mock_bd8fea53465b399f.localStorage));
                        return function () {
                            try {
                                if (!Object(i.i)())
                        ...
                        if ($___old_5f2a47462580f2af)
                            ({}.constructor.defineProperty(window, 'localStorage', $___old_5f2a47462580f2af));
                    }
                }
                function _(t) {
                    try {
            ...
            function (t, e, n) {
                ...
                function o(t) {
                    const $___old_0162bd14c6f29f02 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_95c008d6b1e74536 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_0162bd14c6f29f02)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_c42467539e5891a4.XMLHttpRequest));
                        if ($___old_95c008d6b1e74536)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_c42467539e5891a4.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_0162bd14c6f29f02)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_0162bd14c6f29f02));
                        if ($___old_95c008d6b1e74536)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_95c008d6b1e74536));
                    }
                }
                function c(t, e, n, i) {
                    try {
            ...
            function (t, e, n) {
                ...
                try {
                    ...
                    d ? Object(Qt.b)(new Error('apstag has already loaded - preventing duplicate load'), 'apstag-duplicateLoad', !0) : (Object(r.a)(window) && Object(Qt.b)(new Error('apstag was loaded and then destroyed'), 'apstag-destroyReload', !0), window.apstagLOADED = !0, function () {
                        ...
                        !function () {
                            const $___old_e3977f44625d311c = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                            try {
                                if ($___old_e3977f44625d311c)
                                    ({}.constructor.defineProperty(window, 'localStorage', $___mock_bd8fea53465b399f.localStorage));
                                return function () {
                                    if (Object(Lt.i)()) {
                                ...
                                if ($___old_e3977f44625d311c)
                                    ({}.constructor.defineProperty(window, 'localStorage', $___old_e3977f44625d311c));
                            }
                        }(), Object($t.c)();
                        var et = 0, nt;
                        function rt() {
                            ...
                            if (!Object(Bt.k)(window, !0))
                                try {
                                    ...
                                    Object(Xt.d)({
                                        ...
                                        onload: function t(e) {
                                            const $___old_ab26205098570d1a = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                                            try {
                                                if ($___old_ab26205098570d1a)
                                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_c42467539e5891a4.XMLHttpRequest));
                                                return function () {
                                                ...
                                                if ($___old_ab26205098570d1a)
                                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_ab26205098570d1a));
                                            }
                                        },
                                        onerror: n,
                                        ontimeout: n
