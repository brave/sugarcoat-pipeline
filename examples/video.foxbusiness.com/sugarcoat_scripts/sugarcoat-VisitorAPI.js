var Visitor;
{
    ...
    (function () {
        Visitor = $___var_12bca504f828df5e;
        ...
        function $___var_12bca504f828df5e(t, e) {
            const $___old_c5aa764c57b6e931 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_dad2d3f5e5c5ded9 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
            try {
                if ($___old_c5aa764c57b6e931)
                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_c42467539e5891a4.XMLHttpRequest));
                if ($___old_dad2d3f5e5c5ded9)
                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_c42467539e5891a4.XMLHttpRequest));
                return function () {
                    if (!t)
                    ...
                    var a, k, w = {
                            ...
                            ib: function () {
                                const $___old_04e08863e4e8fa2a = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_081a60f49c28a7ee = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                                try {
                                    if ($___old_04e08863e4e8fa2a)
                                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_c42467539e5891a4.XMLHttpRequest));
                                    if ($___old_081a60f49c28a7ee)
                                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_c42467539e5891a4.XMLHttpRequest));
                                    return function () {
                                    ...
                                    if ($___old_04e08863e4e8fa2a)
                                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_04e08863e4e8fa2a));
                                    if ($___old_081a60f49c28a7ee)
                                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_081a60f49c28a7ee));
                                }
                            },
                            hb: function (a, t, e) {
                                var r = this;
                ...
                if ($___old_c5aa764c57b6e931)
                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_c5aa764c57b6e931));
                if ($___old_dad2d3f5e5c5ded9)
                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_dad2d3f5e5c5ded9));
            }
        }
