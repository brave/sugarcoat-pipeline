{
    const $___mock_a41cd0e2bf1b875e = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    })($___mock_a41cd0e2bf1b875e);
    const $___mock_d471c1a1293de027 = {};
    (exports => {
        'use strict';
        let isSealed = false;
        class Storage {
            ...
            (function () {
                ...
                f.ensureModuleRegistered('signalsFBEventsSendXHR', function () {
                    return function (g, h, i, j) {
                        ...
                        k.exports;
                        (function () {
                            const $___old_9c5a8a9f6aaf0225 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                            try {
                                if ($___old_9c5a8a9f6aaf0225)
                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_a41cd0e2bf1b875e.XMLHttpRequest));
                                return function () {
                                    'use strict';
                                ...
                                if ($___old_9c5a8a9f6aaf0225)
                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_9c5a8a9f6aaf0225));
                            }
                        }());
                        return k.exports;
                    }(a, b, c, d);
            ...
            (function () {
                ...
                f.ensureModuleRegistered('SignalsFBEvents.plugins.iwlbootstrapper', function () {
                    return function (a, b, c, d) {
                        ...
                        e.exports;
                        (function () {
                            const $___old_dcca3c2d93ad7ac2 = {}.constructor.getOwnPropertyDescriptor(window, 'sessionStorage');
                            try {
                                if ($___old_dcca3c2d93ad7ac2)
                                    ({}.constructor.defineProperty(window, 'sessionStorage', $___mock_d471c1a1293de027.sessionStorage));
                                return function () {
                                    'use strict';
                                ...
                                if ($___old_dcca3c2d93ad7ac2)
                                    ({}.constructor.defineProperty(window, 'sessionStorage', $___old_dcca3c2d93ad7ac2));
                            }
                        }());
                        return e.exports;
                    }(a, b, c, d);
