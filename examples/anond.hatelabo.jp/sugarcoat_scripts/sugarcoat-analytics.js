{
    const $___mock_ac19ae711cc0709c = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        ...
        (function () {
            ...
            var bd = function (a) {
                    ...
                    const $___old_f2ede342eb330ba6 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_b78f19b776431d60 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_f2ede342eb330ba6)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_ac19ae711cc0709c.XMLHttpRequest));
                        if ($___old_b78f19b776431d60)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_ac19ae711cc0709c.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_f2ede342eb330ba6)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_f2ede342eb330ba6));
                        if ($___old_b78f19b776431d60)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_b78f19b776431d60));
                    }
                }, Ea = function (a, b, c) {
                    if (1 > b.length)
                        ge('xhr', 'ver', '0'), c();
