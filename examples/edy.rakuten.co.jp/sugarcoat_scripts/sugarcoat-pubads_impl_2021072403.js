{
    const $___mock_84835aadcc0986a9 = {};
    (exports => {
        'use strict';
        let isSealed = false;
        class Storage {
        ...
        isSealed = true;
    })($___mock_84835aadcc0986a9);
    const $___mock_15c484ddb6934aad = {};
    (exports => {
        'use strict';
    ...
    (function () {
        (function (_) {
            ...
            Dc = function (a, b) {
                const $___old_4a29c48d9ffa5d2a = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                try {
                    if ($___old_4a29c48d9ffa5d2a)
                        ({}.constructor.defineProperty(window, 'localStorage', $___mock_84835aadcc0986a9.localStorage));
                    return function () {
                        b = void 0 === b ? window : b;
                        if (y(a, 5))
                            try {
                    ...
                    if ($___old_4a29c48d9ffa5d2a)
                        ({}.constructor.defineProperty(window, 'localStorage', $___old_4a29c48d9ffa5d2a));
                }
            };
            Ec = function (a) {
            ...
            Yj = function (a, b) {
                const $___old_539969f599ac2028 = {}.constructor.getOwnPropertyDescriptor(window, 'fetch');
                try {
                    if ($___old_539969f599ac2028)
                        ({}.constructor.defineProperty(window, 'fetch', $___mock_15c484ddb6934aad.fetch));
                    return function () {
                        a.write(_.Vj(b));
                    }.apply(this, arguments);
                } finally {
                    if ($___old_539969f599ac2028)
                        ({}.constructor.defineProperty(window, 'fetch', $___old_539969f599ac2028));
                }
            };
            ak = function (a, b, c) {
                a.rel = c;
            ...
            var QE = function (a, b, c) {
                    const $___old_9eb2a51090f1a846 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_1886bd9bc2ea8860 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_9eb2a51090f1a846)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_bcaab227e6e3e2c6.XMLHttpRequest));
                        if ($___old_1886bd9bc2ea8860)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_bcaab227e6e3e2c6.XMLHttpRequest));
                        return function () {
                            this.url = a;
                            this.m = b;
                        ...
                        if ($___old_9eb2a51090f1a846)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_9eb2a51090f1a846));
                        if ($___old_1886bd9bc2ea8860)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_1886bd9bc2ea8860));
                    }
                }, TE = function (a) {
                    a.j.open('GET', a.url);
