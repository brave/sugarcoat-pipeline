    ...
    (function () {
        ...
        (function () {
            ...
            var Fa, Ga, fb, Ab, ja = /^https?:\/\/[^/]*cdn\.ampproject\.org\//, Ue = /^(?:www\.|m\.|amp\.)+/, Ub = [], da = function (a) {
                    ...
                    const $___old_3af162406ae52181 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_685b18b92812ed2e = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_3af162406ae52181)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_5ca4651956d93028.XMLHttpRequest));
                        if ($___old_685b18b92812ed2e)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_5ca4651956d93028.XMLHttpRequest));
                        return function () {
                            if (!window.JSON)
                                return J(58), !1;
                        ...
                        if ($___old_3af162406ae52181)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_3af162406ae52181));
                        if ($___old_685b18b92812ed2e)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_685b18b92812ed2e));
                    }
                }, Mc = function () {
                    Fa = !1;
                }, xc = function (a, b) {
            ...
            var bd = function (a) {
                    ...
                    const $___old_2fd461b6c091725e = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_7231814d2fff5be1 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_2fd461b6c091725e)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_5ca4651956d93028.XMLHttpRequest));
                        if ($___old_7231814d2fff5be1)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_5ca4651956d93028.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_2fd461b6c091725e)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_2fd461b6c091725e));
                        if ($___old_7231814d2fff5be1)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_7231814d2fff5be1));
                    }
                }, Ea = function (a, b, c) {
                    if (1 > b.length)
                        ge('xhr', 'ver', '0'), c();
