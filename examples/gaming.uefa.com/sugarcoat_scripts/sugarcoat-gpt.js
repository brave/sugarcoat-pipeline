{
    const $___mock_fdf4348acca67e21 = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        (function (E) {
            ...
            var Dg = function (a) {
                    ...
                    const $___old_f8833845279e61db = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_b52f3a29cb598e26 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_f8833845279e61db)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_fdf4348acca67e21.XMLHttpRequest));
                        if ($___old_b52f3a29cb598e26)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_fdf4348acca67e21.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_f8833845279e61db)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_f8833845279e61db));
                        if ($___old_b52f3a29cb598e26)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_b52f3a29cb598e26));
                    }
                }, Ng = function (a, b, c, d) {
                    sg(172, d);
                    sg(259, Hg(a));
