var Sentry;
{
    const $___mock_0e5d5f86b1a76f4f = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    })($___mock_0e5d5f86b1a76f4f);
    const $___mock_876f854bf712ff0f = {};
    (exports => {
        'use strict';
    ...
    })($___mock_876f854bf712ff0f);
    (function () {
        var $___var_2480d55a00df0fff = function (t) {
            var n = function (t, r) {
            ...
            var k = function (t) {
                    ...
                    return t.prototype.toString = function (t) {
                        ...
                        var r = f(n.slice(1), 6), e = r[0], i = r[1], o = r[2], u = void 0 === o ? '' : o, s = r[3], c = r[4], a = void 0 === c ? '' : c, h = '', v = r[5], l = v.split('/');
                        ...
                        if ([
                                ...
                                if (!t[n])
                                    throw new k('Invalid Dsn: ' + n + ' missing');
                    ...
                    return t.prototype.memoize = function (t) {
                        if (this.u)
                            return !!this.s.has(t) || (this.s.add(t), !1);
            ...
            function H(t, n, r, e) {
                ...
                if (e.memoize(n))
                    return '[Circular ~]';
                for (var s in o)
                    Object.prototype.hasOwnProperty.call(o, s) && (u[s] = H(s, o[s], r - 1, e));
                ...
                if (!at[t])
                    ...
                    case 'dom':
                        !function () {
                            if (!('document' in st))
                                return;
                            st.document.addEventListener('click', wt('click', vt.bind(null, 'dom')), !1), st.document.addEventListener('keypress', gt(vt.bind(null, 'dom')), !1), [
                                'EventTarget',
                                'Node'
                            ].forEach(function (t) {
                    ...
                    case 'xhr':
                        !function () {
                            const $___old_a9ae72fc0ca1976e = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                            try {
                                if ($___old_a9ae72fc0ca1976e)
                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_0e5d5f86b1a76f4f.XMLHttpRequest));
                                return function () {
                                ...
                                if ($___old_a9ae72fc0ca1976e)
                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_a9ae72fc0ca1976e));
                            }
                        }();
                        break;
                    case 'fetch':
                        !function () {
                            ...
                            A(st, 'fetch', function (t) {
                                return function () {
                                    const $___old_08a4b18a74ea8700 = {}.constructor.getOwnPropertyDescriptor(window, 'fetch');
                                    try {
                                        if ($___old_08a4b18a74ea8700)
                                            ({}.constructor.defineProperty(window, 'fetch', $___mock_876f854bf712ff0f.fetch));
                                        return function () {
                                            for (var n = [], r = 0; r < arguments.length; r++)
                                                n[r] = arguments[r];
                                            var e = {
                                            ...
                                            return vt('fetch', c({}, e)), t.apply(st, n).then(function (t) {
                                                return vt('fetch', c(c({}, e), {
                                                    endTimestamp: Date.now(),
                                                    response: t
                                                })), t;
                                            }, function (t) {
                                                throw vt('fetch', c(c({}, e), {
                                                    endTimestamp: Date.now(),
                                                    error: t
                                                })), t;
                                            });
                                        ...
                                        if ($___old_08a4b18a74ea8700)
                                            ({}.constructor.defineProperty(window, 'fetch', $___old_08a4b18a74ea8700));
                                    }
                                };
                            });
                        }();
                    ...
                    case 'history':
                        !function () {
                            if (t = W(), n = t.chrome, r = n && n.app && n.app.runtime, e = 'history' in t && !!t.history.pushState && !!t.history.replaceState, r || !e)
                                return;
                            var t, n, r, e;
                            var i = st.onpopstate;
                            function o(t) {
            ...
            var Ot = B() ? function () {
                    ...
                    nowSeconds: function () {
                        return (Ot.timeOrigin + Ot.now()) / 1000;
                    }
            ...
            var Mt = function () {
                    ...
                    return t.prototype.isOlderThan = function (t) {
                        ...
                        this.endSession();
                        var n = this.getStackTop(), r = n.scope, e = n.client, i = e && e.getOptions() || {}, o = i.release, u = i.environment, s = new Mt(c(c({
                                release: o,
                                environment: u
                            }, r && { user: r.getUser() }), t));
            ...
            var Gt, zt = function () {
                    ...
                    return t.prototype.captureException = function (t, n, r) {
                        ...
                        var i = this, o = r && r.event_id, u = y(t) ? this.ct().eventFromMessage(String(t), n, r) : this.ct().eventFromException(t, r);
                        ...
                        t.update(c(c({}, u && { status: i.Crashed }), {
                            user: d,
                            userAgent: o,
                        ...
                        var e = this, i = this.getOptions().normalizeDepth, o = void 0 === i ? 3 : i, u = c(c({}, t), {
                        ...
                        var n = this.getOptions(), r = n.environment, e = n.release, i = n.dist, o = n.maxValueLength, u = void 0 === o ? 250 : o;
            ...
            var Zt = function () {
                    ...
                    FunctionToString: Zt,
                    InboundFilters: nn
                }), en = '?', on = /^\s*at (?:(.*?) ?\()?((?:file|https?|blob|chrome-extension|address|native|eval|webpack|<anonymous>|[-a-z]+:|.*bundle|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, un = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:file|https?|blob|chrome|webpack|resource|moz-extension|capacitor).*?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. \/=]+)(?::(\d+))?(?::(\d+))?\s*$/i, sn = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, cn = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, an = /\((\S*)(?::(\d+))(?::(\d+))\)/, fn = /Minified React error #\d+;/i;
            function hn(t) {
                var n = null, r = 0;
            ...
            var xn = function () {
                    ...
                    return n.prototype.sendEvent = function (t) {
                        ...
                        var r = n.requestType, e = n.response, i = n.headers, o = n.resolve, u = n.reject, s = t.Status.fromHttpCode(e.status);
                    ...
                    return r(e, n), e.prototype.eventFromException = function (t, n) {
                        ...
                        if (!this.ot.dsn)
                            return n.prototype.xt.call(this);
            ...
            function Rn(t, n, r) {
                ...
                var sentryWrapped = function () {
                    const $___old_611c763706d58a21 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_845f4893313d8112 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_611c763706d58a21)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_0e5d5f86b1a76f4f.XMLHttpRequest));
                        if ($___old_845f4893313d8112)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_0e5d5f86b1a76f4f.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_611c763706d58a21)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_611c763706d58a21));
                        if ($___old_845f4893313d8112)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_845f4893313d8112));
                    }
                };
                try {
                    for (var e in t)
            ...
            var Nn = function () {
                    function n(t) {
                        this.name = n.id, this.Ut = !1, this.Ht = !1, this.ot = c({
                            onerror: !0,
                    ...
                    return n.prototype.setupOnce = function () {
                        ...
                        this.Ht || (ht({
                            callback: function (e) {
                                ...
                                if (!u || Dn() || s)
                                    return !0;
                                var c = o.getClient(), a = y(i) ? r.Jt(i) : gn(i, void 0, {
                        ...
                        var i = isNaN(parseInt(e, 10)) ? void 0 : e, o = isNaN(parseInt(r, 10)) ? void 0 : r, u = p(n) && n.length > 0 ? n : function () {
                                try {
                    ...
                    return t.prototype.setupOnce = function () {
                        const $___old_13e1511569222774 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                        try {
                            if ($___old_13e1511569222774)
                                ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_0e5d5f86b1a76f4f.XMLHttpRequest));
                            return function () {
                                var t = W();
                            ...
                            if ($___old_13e1511569222774)
                                ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_13e1511569222774));
                        }
                    }, t.prototype.Wt = function (t) {
                        return function () {
                            for (var n = [], r = 0; r < arguments.length; r++)
                        ...
                        const $___old_ae0590350a20721c = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                        try {
                            if ($___old_ae0590350a20721c)
                                ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_0e5d5f86b1a76f4f.XMLHttpRequest));
                            return function () {
                            ...
                            if ($___old_ae0590350a20721c)
                                ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_ae0590350a20721c));
                        }
        ...
        Sentry = $___var_2480d55a00df0fff;
    }())
}