var UET, UET_init, UET_push;
{
    ...
    (function () {
        ...
        UET_init = $___var_d6214865acafadde;
        ...
        UET_push = $___var_9fd1286d8e7b784b;
        ...
        function $___var_7662dcf70c894582(o) {
            ...
            this.loadConfig = function () {
                const $___old_d0e67ac272a19fa2 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                try {
                    if ($___old_d0e67ac272a19fa2)
                    ...
                    if ($___old_d0e67ac272a19fa2)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_d0e67ac272a19fa2));
                }
            };
            this.push = function () {
            ...
            this.setLocalStorageBackup = function (n, t, i) {
                const $___old_c427cb568a4e3554 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                try {
                    if ($___old_c427cb568a4e3554)
                    ...
                    if ($___old_c427cb568a4e3554)
                        ({}.constructor.defineProperty(window, 'localStorage', $___old_c427cb568a4e3554));
                }
            };
            this.getLocalStorageBackup = function (n, t) {
                const $___old_91bcfb8af450ce98 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                try {
                    if ($___old_91bcfb8af450ce98)
                        ({}.constructor.defineProperty(window, 'localStorage', $___mock_6311a65d4da22df7.localStorage));
                    return function () {
                        var r, i;
                        try {
                    ...
                    if ($___old_91bcfb8af450ce98)
                        ({}.constructor.defineProperty(window, 'localStorage', $___old_91bcfb8af450ce98));
                }
            };
