{
    const $___mock_891a32ecb9f1ebc0 = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        ...
        (function () {
            ...
            var bd = function (a) {
                    ...
                    const $___old_32f008d0d51e859b = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_f300ee92cfe3fc9e = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_32f008d0d51e859b)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_891a32ecb9f1ebc0.XMLHttpRequest));
                        if ($___old_f300ee92cfe3fc9e)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_891a32ecb9f1ebc0.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_32f008d0d51e859b)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_32f008d0d51e859b));
                        if ($___old_f300ee92cfe3fc9e)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_f300ee92cfe3fc9e));
                    }
                }, Ea = function (a, b, c) {
                    if (1 > b.length)
                        ge('xhr', 'ver', '0'), c();
