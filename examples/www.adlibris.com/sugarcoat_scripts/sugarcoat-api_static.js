{
    const $___mock_18a641aff9f4f290 = {};
    (exports => {
        'use strict';
        let isSealed = false;
        class Storage {
    ...
    (function () {
        window.DYO = window.DYO || {}, void 0 === window.DY && (window.DY = {}), void 0 === window.DY.API && (window.DY.API = function () {
            ...
            function a(a) {
                const $___old_bc59db5249ef0245 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage'), $___old_2182a8d7be6e9774 = {}.constructor.getOwnPropertyDescriptor(window, 'sessionStorage');
                try {
                    if ($___old_bc59db5249ef0245)
                        ({}.constructor.defineProperty(window, 'localStorage', $___mock_18a641aff9f4f290.localStorage));
                    if ($___old_2182a8d7be6e9774)
                        ({}.constructor.defineProperty(window, 'sessionStorage', $___mock_18a641aff9f4f290.sessionStorage));
                    return function () {
                        try {
                    ...
                    if ($___old_bc59db5249ef0245)
                        ({}.constructor.defineProperty(window, 'localStorage', $___old_bc59db5249ef0245));
                    if ($___old_2182a8d7be6e9774)
                        ({}.constructor.defineProperty(window, 'sessionStorage', $___old_2182a8d7be6e9774));
                }
            }
            function b(a) {
            ...
            return k.memoryStorage = function () {
                ...
                const $___old_1c67b4fd97d0e9cc = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                try {
                    if ($___old_1c67b4fd97d0e9cc)
                        ({}.constructor.defineProperty(window, 'localStorage', $___mock_18a641aff9f4f290.localStorage));
                    return function () {
                        if (!b())
                    ...
                    if ($___old_1c67b4fd97d0e9cc)
                        ({}.constructor.defineProperty(window, 'localStorage', $___old_1c67b4fd97d0e9cc));
                }
            }(), k.sessionStorage = function () {
                const $___old_a4e6b5580d77dc86 = {}.constructor.getOwnPropertyDescriptor(window, 'sessionStorage');
                try {
                    if ($___old_a4e6b5580d77dc86)
                        ({}.constructor.defineProperty(window, 'sessionStorage', $___mock_18a641aff9f4f290.sessionStorage));
                    return function () {
                        if (!b())
                    ...
                    if ($___old_a4e6b5580d77dc86)
                        ({}.constructor.defineProperty(window, 'sessionStorage', $___old_a4e6b5580d77dc86));
                }
            ...
            function f(a, b, c) {
                ...
                function g() {
                    const $___old_0bbce488e54aa33b = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                    try {
                        if ($___old_0bbce488e54aa33b)
                            ({}.constructor.defineProperty(window, 'localStorage', $___mock_18a641aff9f4f290.localStorage));
                        return function () {
                            var a;
                            try {
                        ...
                        if ($___old_0bbce488e54aa33b)
                            ({}.constructor.defineProperty(window, 'localStorage', $___old_0bbce488e54aa33b));
                    }
                }
