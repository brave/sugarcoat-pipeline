{
    const $___mock_83548ed267b0d58b = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        ...
        (function () {
            ...
            var bd = function (a) {
                    ...
                    const $___old_8006d23244c80244 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_aa32d1f8c3c44104 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_8006d23244c80244)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_83548ed267b0d58b.XMLHttpRequest));
                        if ($___old_aa32d1f8c3c44104)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_83548ed267b0d58b.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_8006d23244c80244)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_8006d23244c80244));
                        if ($___old_aa32d1f8c3c44104)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_aa32d1f8c3c44104));
                    }
                }, Ea = function (a, b, c) {
                    if (1 > b.length)
                        ge('xhr', 'ver', '0'), c();
