{
    const $___mock_68be6156c4d4407c = {};
    (exports => {
        'use strict';
        let isSealed = false;
        class Storage {
    ...
    (function () {
        !function (i) {
            ...
            i.universalAnalytics = {
                ...
                ip: void 0,
                generateId: function () {
                    const $___old_ad4c5dc9d0e66742 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                    try {
                        if ($___old_ad4c5dc9d0e66742)
                            ({}.constructor.defineProperty(window, 'localStorage', $___mock_68be6156c4d4407c.localStorage));
                        return function () {
                ...
                init: function (n, a, t, e, s, l, o, r, c, u) {
                    ...
                    try {
                        ...
                        return function () {
                            if ('undefined' == typeof i.FBO || !i.FBO.Config.DisableViewTracking) {
                                ...
                                if (y && y.clientId)
                                    ...
                                    try {
                                        d = localStorage.getItem('clientId');
                                    } catch (v) {
                                        console.log('No access to localStorage.');
                                    } finally {
                                        d = d || i.universalAnalytics.generateId();
                                    }
                                for (var p = {
                                            allowLinker: !0,
                                            storage: 'none',
                                            storeGac: !1,
                                            clientId: d
                                        }, A = 0, h = i.universalAnalytics.uaIDs.length; A < h; A++)
                                    i.ua('create', i.universalAnalytics.uaIDs[A], i.universalAnalytics.url, 'additional' + A.toString(), p);
                        ...
                        if ($___old_00a3425839962860)
                            ({}.constructor.defineProperty(window, 'localStorage', $___old_00a3425839962860));
                    }
                },
            ...
            a.prototype.subscribe = function (n) {
                ...
                this.analytics.print(i.filename, e(i.option), i.number);
            }, a.prototype.download = function (i) {
                this.analytics.download(i.url, e(i.option));
