...
{
    const $___mock_c886847000708ea9 = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    })($___mock_c886847000708ea9);
    (function () {
        AppMeasurement_Module_AudienceManagement = $___var_6d4fba564b84f0ef;
        ...
        function $___var_6d4fba564b84f0ef(e) {
            var t = this;
            t.s = e;
            var n = window;
        ...
        !function () {
            ...
            'function' != typeof window.DIL && (window.DIL = function (n, e) {
                const $___old_ea9939960846a843 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_5640d25d55353e20 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                try {
                    if ($___old_ea9939960846a843)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_c886847000708ea9.XMLHttpRequest));
                    if ($___old_5640d25d55353e20)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_c886847000708ea9.XMLHttpRequest));
                    return function () {
                        function t(e) {
                            return void 0 === e || !0 === e;
                    ...
                    if ($___old_ea9939960846a843)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_ea9939960846a843));
                    if ($___old_5640d25d55353e20)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_5640d25d55353e20));
                }
