{
    const $___mock_a86e2cfb51edcf3c = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    })($___mock_a86e2cfb51edcf3c);
    const $___mock_6bc19e92f5fca12b = {};
    (exports => {
        'use strict';
        let isSealed = false;
        class Storage {
                ...
                (function (e) {
                    ...
                    function f(n, o) {
                        ...
                        return t.awaitCookieSettings().then(function (e) {
                            const $___old_97beee1be40f31b4 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_20ea833272d4224b = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage'), $___old_6743636d21837474 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                            try {
                                if ($___old_97beee1be40f31b4)
                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_a86e2cfb51edcf3c.XMLHttpRequest));
                                if ($___old_20ea833272d4224b)
                                    ({}.constructor.defineProperty(window, 'localStorage', $___mock_6bc19e92f5fca12b.localStorage));
                                if ($___old_6743636d21837474)
                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_a86e2cfb51edcf3c.XMLHttpRequest));
                                return function () {
                                    if (null != e.match(n)) {
                                        if (i)
                                ...
                                if ($___old_97beee1be40f31b4)
                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_97beee1be40f31b4));
                                if ($___old_20ea833272d4224b)
                                    ({}.constructor.defineProperty(window, 'localStorage', $___old_20ea833272d4224b));
                                if ($___old_6743636d21837474)
                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_6743636d21837474));
                            }
                        }).catch(function () {
