{
    const $___mock_f056c1781bca73fe = {};
    (exports => {
        'use strict';
        let isSealed = false;
        class Storage {
    ...
    (function () {
        (function (_) {
            ...
            Dc = function (a, b) {
                const $___old_9d7cde0e5fd9e13b = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                try {
                    if ($___old_9d7cde0e5fd9e13b)
                        ({}.constructor.defineProperty(window, 'localStorage', $___mock_f056c1781bca73fe.localStorage));
                    return function () {
                        b = void 0 === b ? window : b;
                        if (y(a, 5))
                            try {
                    ...
                    if ($___old_9d7cde0e5fd9e13b)
                        ({}.constructor.defineProperty(window, 'localStorage', $___old_9d7cde0e5fd9e13b));
                }
            };
            Ec = function (a) {
            ...
            xs.prototype.push = function (a) {
                const $___old_6514291bd225b1f0 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_1f19127987b3922d = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                try {
                    if ($___old_6514291bd225b1f0)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_360af56e9fcd1aba.XMLHttpRequest));
                    if ($___old_1f19127987b3922d)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_360af56e9fcd1aba.XMLHttpRequest));
                    return function () {
                    ...
                    if ($___old_6514291bd225b1f0)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_6514291bd225b1f0));
                    if ($___old_1f19127987b3922d)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_1f19127987b3922d));
                }
            };
            var zs = function (a) {
                R.call(this, a, -1, ys);
            ...
            var QE = function (a, b, c) {
                    const $___old_4161c921cb59694e = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_e6aaa8ec00c771fc = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_4161c921cb59694e)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_360af56e9fcd1aba.XMLHttpRequest));
                        if ($___old_e6aaa8ec00c771fc)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_360af56e9fcd1aba.XMLHttpRequest));
                        return function () {
                            this.url = a;
                            this.m = b;
                        ...
                        if ($___old_4161c921cb59694e)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_4161c921cb59694e));
                        if ($___old_e6aaa8ec00c771fc)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_e6aaa8ec00c771fc));
                    }
                }, TE = function (a) {
                    a.j.open('GET', a.url);
