{
    const $___mock_f66903271e3f8c29 = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        ...
        (function () {
            ...
            var bd = function (a) {
                    ...
                    const $___old_742f804c6b57d8f9 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_b884da36dcf77b30 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_742f804c6b57d8f9)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_f66903271e3f8c29.XMLHttpRequest));
                        if ($___old_b884da36dcf77b30)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_f66903271e3f8c29.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_742f804c6b57d8f9)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_742f804c6b57d8f9));
                        if ($___old_b884da36dcf77b30)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_b884da36dcf77b30));
                    }
                }, Ea = function (a, b, c) {
                    if (1 > b.length)
                        ge('xhr', 'ver', '0'), c();
