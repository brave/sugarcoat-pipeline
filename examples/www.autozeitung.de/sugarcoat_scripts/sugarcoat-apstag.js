{
    ...
    const $___mock_ae2e95874a67a666 = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        !function (t) {
            ...
            function (t, e, n) {
                ...
                function f() {
                    const $___old_baf7a2596157adc5 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                    try {
                        if ($___old_baf7a2596157adc5)
                        ...
                        if ($___old_baf7a2596157adc5)
                            ({}.constructor.defineProperty(window, 'localStorage', $___old_baf7a2596157adc5));
                    }
                }
                function b(t, e) {
            ...
            function (t, e, n) {
                const $___old_7f77e510d2cf59e9 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_fb469da0b27d5138 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                try {
                    if ($___old_7f77e510d2cf59e9)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_ae2e95874a67a666.XMLHttpRequest));
                    if ($___old_fb469da0b27d5138)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_ae2e95874a67a666.XMLHttpRequest));
                    return function () {
                        'use strict';
                        n.d(e, 'g', function () {
                    ...
                    if ($___old_7f77e510d2cf59e9)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_7f77e510d2cf59e9));
                    if ($___old_fb469da0b27d5138)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_fb469da0b27d5138));
                }
            },
            function (t, e, n) {
                'use strict';
                ...
                function w() {
                    const $___old_f2efe77eff4bb2a2 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                    try {
                        if ($___old_f2efe77eff4bb2a2)
                            ({}.constructor.defineProperty(window, 'localStorage', $___mock_f8a288802595a372.localStorage));
                        return function () {
                            try {
                                if (!Object(i.i)())
                        ...
                        if ($___old_f2efe77eff4bb2a2)
                            ({}.constructor.defineProperty(window, 'localStorage', $___old_f2efe77eff4bb2a2));
                    }
                }
                function _(t) {
                    try {
            ...
            function (t, e, n) {
                ...
                function o(t) {
                    const $___old_2a35e2c56c78c57b = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_3fd604c9bd01d760 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_2a35e2c56c78c57b)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_ae2e95874a67a666.XMLHttpRequest));
                        if ($___old_3fd604c9bd01d760)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_ae2e95874a67a666.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_2a35e2c56c78c57b)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_2a35e2c56c78c57b));
                        if ($___old_3fd604c9bd01d760)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_3fd604c9bd01d760));
                    }
                }
                function c(t, e, n, i) {
                    try {
            ...
            function (t, e, n) {
                ...
                function r() {
                    const $___old_d7b1d39556f63faf = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                    try {
                        if ($___old_d7b1d39556f63faf)
                            ({}.constructor.defineProperty(window, 'localStorage', $___mock_f8a288802595a372.localStorage));
                        return function () {
                        ...
                        if ($___old_d7b1d39556f63faf)
                            ({}.constructor.defineProperty(window, 'localStorage', $___old_d7b1d39556f63faf));
                    }
                }
                function f() {
                    try {
            ...
            function (t, e, n) {
                ...
                try {
                    ...
                    d ? Object(Qt.b)(new Error('apstag has already loaded - preventing duplicate load'), 'apstag-duplicateLoad', !0) : (Object(r.a)(window) && Object(Qt.b)(new Error('apstag was loaded and then destroyed'), 'apstag-destroyReload', !0), window.apstagLOADED = !0, function () {
                        ...
                        !function () {
                            const $___old_89cc8df88ea8dac9 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                            try {
                                if ($___old_89cc8df88ea8dac9)
                                    ({}.constructor.defineProperty(window, 'localStorage', $___mock_f8a288802595a372.localStorage));
                                return function () {
                                    if (Object(Lt.i)()) {
                                ...
                                if ($___old_89cc8df88ea8dac9)
                                    ({}.constructor.defineProperty(window, 'localStorage', $___old_89cc8df88ea8dac9));
                            }
                        }(), Object($t.c)();
                        var et = 0, nt;
                        function rt() {
                            ...
                            if (!Object(Bt.k)(window, !0))
                                try {
                                    ...
                                    Object(Xt.d)({
                                        ...
                                        onload: function t(e) {
                                            const $___old_89b1faa222819012 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                                            try {
                                                if ($___old_89b1faa222819012)
                                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_ae2e95874a67a666.XMLHttpRequest));
                                                return function () {
                                                ...
                                                if ($___old_89b1faa222819012)
                                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_89b1faa222819012));
                                            }
                                        },
                                        onerror: n,
                                        ontimeout: n
