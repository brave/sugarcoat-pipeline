{
    const $___mock_4154ab5ebc510d8e = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        ...
        (function () {
            ...
            var bd = function (a) {
                    ...
                    const $___old_31df7c54a825f890 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_3f1e1faa83256745 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_31df7c54a825f890)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_4154ab5ebc510d8e.XMLHttpRequest));
                        if ($___old_3f1e1faa83256745)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_4154ab5ebc510d8e.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_31df7c54a825f890)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_31df7c54a825f890));
                        if ($___old_3f1e1faa83256745)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_3f1e1faa83256745));
                    }
                }, Ea = function (a, b, c) {
                    if (1 > b.length)
                        ge('xhr', 'ver', '0'), c();
