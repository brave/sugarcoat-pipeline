{
    const $___mock_bccfa663ec21af92 = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    })($___mock_bccfa663ec21af92);
    const $___mock_9378733a4497ef44 = {};
    (exports => {
        'use strict';
        let isSealed = false;
        class Storage {
            ...
            (function () {
                ...
                f.ensureModuleRegistered('signalsFBEventsSendXHR', function () {
                    return function (g, h, i, j) {
                        ...
                        k.exports;
                        (function () {
                            const $___old_24487a7225e6c75f = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_85aa2ac0eb4c7fd8 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                            try {
                                if ($___old_24487a7225e6c75f)
                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_bccfa663ec21af92.XMLHttpRequest));
                                if ($___old_85aa2ac0eb4c7fd8)
                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_bccfa663ec21af92.XMLHttpRequest));
                                return function () {
                                    'use strict';
                                ...
                                if ($___old_24487a7225e6c75f)
                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_24487a7225e6c75f));
                                if ($___old_85aa2ac0eb4c7fd8)
                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_85aa2ac0eb4c7fd8));
                            }
                        }());
                        return k.exports;
                    }(a, b, c, d);
            ...
            (function () {
                ...
                f.ensureModuleRegistered('SignalsFBEvents.plugins.iwlbootstrapper', function () {
                    return function (a, b, c, d) {
                        ...
                        e.exports;
                        (function () {
                            const $___old_5ae3929c06afc7f5 = {}.constructor.getOwnPropertyDescriptor(window, 'sessionStorage');
                            try {
                                if ($___old_5ae3929c06afc7f5)
                                    ({}.constructor.defineProperty(window, 'sessionStorage', $___mock_9378733a4497ef44.sessionStorage));
                                return function () {
                                    'use strict';
                                ...
                                if ($___old_5ae3929c06afc7f5)
                                    ({}.constructor.defineProperty(window, 'sessionStorage', $___old_5ae3929c06afc7f5));
                            }
                        }());
                        return e.exports;
                    }(a, b, c, d);
